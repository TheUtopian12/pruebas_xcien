...
const Nosotros = () => {
  return (
    <div className="flex flex-col justify-center text-center h-auto bg-white dark:bg-black">
       <p className="pt-10  font-extrabold text-transparent text-5xl bg-clip-text bg-gradient-to-r from-green-400 to-yellow-600">
      Nosotros
    </p>

      <div className="flex">
        <div className="w-[50%]">
          <p className="pt-60 mr-[100px] pl-[200px] text-center text-xl">
      ...
      <p className="-translate-y-[43px] z-20 font-extrabold text-transparent text-4xl bg-clip-text bg-gradient-to-r from-yellow-400 to-green-600">
